package com.example.clubesbrasileiros.utils;
...
import com.example.clubesbrasileiros.R;
...
public class UtilsAlert {
    ...
    public static void confirmarAcao(Context context, String mensagem, DialogInterface.OnClickListener listenerSim, DialogInterface.OnClickListener listenerNao){
        ...
        builder.setPositiveButton(R.string.yes, (DialogInterface.OnClickListener) listenerSim);
        builder.setNegativeButton(R.string.no, (DialogInterface.OnClickListener) listenerNao);

        AlertDialog alertDialog = builder.create();
        alertDialog.show();
    }

    /* Interface para receber texto inserido no AlertDialog
       exibido pelo lerTexto */

    public interface OnTextEnteredListener {
        void onTextEntered(String texto);
    }

    public static void lerTexto(Context context, int idTitulo, int idLayout, int idEditText,
